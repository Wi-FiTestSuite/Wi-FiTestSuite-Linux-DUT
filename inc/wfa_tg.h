...
#define KW_HTI                     20
#define KW_DSCP                    21
#define KW_BURSTPERIODICITY        22
#define KW_BURSTFRAGS              23
...
#define TG_WMM_AC_UP8         19     /*               7 */
#define TG_WMM_AC_UP7         20     /*               7 */
#define TG_DSCP_46            22     /* DSCP 0d46 -> TOS 0xb8 */
#define TG_DSCP_34            23     /* DSCP 0d34 -> TOS 0x88 */
...
extern int wfaSendBurstData(int mySockfd, int streamId, BYTE *pRespBuf, int *aRespLen);
