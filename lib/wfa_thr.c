...
//#endif
    ...
    while(1)
    {
        ...
        case DIRECT_SEND:
            ...
            if (myProfile->profile == PROF_IPTV || myProfile->profile == PROF_FILE_TX || myProfile->profile == PROF_MCAST || myProfile->profile == PROF_BURST) /* PROF_BURST has to be extended if needed */
            {
                int iOptVal, iOptLen;
                ...
                if (myProfile->burstfrags && myProfile->burstperiodicity)
                {
                    wfaSendBurstData(mySock, myStreamId, respBuf, &respLen);
                }
        ...
        case DIRECT_RECV:
            ...
            else if (myProfile->profile == PROF_IPTV || myProfile->profile == PROF_FILE_TX || myProfile->profile == PROF_MCAST || myProfile->profile == PROF_BURST) /* PROF_BURST has to be extended if needed */
            {
                ...
                printf("init E2Cnt %i\n", totalE2Cnt);
                if(myProfile->profile == PROF_IPTV || myProfile->profile == PROF_BURST) /* PROF_BURST has to be extended if needed */
                {
